  ...
  return (
    <>
      ...
      <section id="hero" className="hero" aria-labelledby="hero-title">
        {/* Decoración detrás del hero — confinada al lado derecho para no
            tapar el texto. Anillo conic-gradient rotante + sparkles. */}
        <div className="hero-decor" aria-hidden="true">
          <span className="hero-decor-ring" />
          <span className="hero-decor-glow" />
          <span className="hero-decor-spark s1" />
          <span className="hero-decor-spark s2" />
          <span className="hero-decor-spark s3" />
          <span className="hero-decor-spark s4" />
          <span className="hero-decor-spark s5" />
        </div>
